...
let a1= Array.from(new Set(objs.map(a =>{return a.a}))).sort((a,b) =>{return a-b})       
 let  b = a1.splice(5,4,10,10,10,10)
...
将https://www.ddxs.cc/ddxs/167993/此小说的章节和内容采集下来，并且内容不能有标签2.2.
